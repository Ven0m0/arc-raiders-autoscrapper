...
2. **Rule format:**
  ...
  1. **Do not edit `items_rules.default.json`** - it is overwritten by the update script. Add custom rules to your custom rules file (configured in Settings).

  2. **Validate after adding:**
