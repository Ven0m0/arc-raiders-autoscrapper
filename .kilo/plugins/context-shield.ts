...
const SLIM_DESCRIPTIONS: Record<string, string> = {
  ...
  ast_grep: "AST structural code search (25 langs). Meta-vars: $VAR (node), $$$ (many). Prefer over grep for function/class/call patterns.",
  ast_grep_replace: "AST structural code replace (dry-run by default). Use $VAR/$$$ to rewrite matched patterns in-place.",
