...
- `src/autoscrapper/ocr/inventory_vision.py`, `src/autoscrapper/scanner/`, `src/autoscrapper/core/item_actions.py`, `src/autoscrapper/items/rules_store.py`, `src/autoscrapper/config.py`
