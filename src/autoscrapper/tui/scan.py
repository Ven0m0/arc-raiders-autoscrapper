    ...
    def _run_scan(self, window_snapshot: WindowSnapshot | None) -> None:
        ...
        try:
            ...
            results, stats = scan_inventory(
                ...
                input_action_delay_ms=settings.input_action_delay_ms,
                cell_infobox_left_right_click_gap_ms=settings.cell_infobox_left_right_click_gap_ms,
                item_infobox_settle_delay_ms=settings.item_infobox_settle_delay_ms,
                post_sell_recycle_delay_ms=settings.post_sell_recycle_delay_ms,
                infobox_retries=settings.infobox_retries,
                infobox_retry_interval_ms=settings.infobox_retry_interval_ms,
                ocr_unreadable_retries=settings.ocr_unreadable_retries,
                ocr_retry_interval_ms=settings.ocr_retry_interval_ms,
                progress=progress,
